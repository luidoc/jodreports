...
import com.ejemplos.jodreports.templates.xmlfilters.DynamicImageFilter;
import com.ejemplos.jodreports.templates.xmlfilters.ScriptTagFilter;
import com.ejemplos.jodreports.templates.xmlfilters.TextInputTagFilter;
...
public abstract class AbstractDocumentTemplate implements DocumentTemplate {
	...
	private static final Configuration DEFAULT_FREEMARKER_CONFIGURATION = new Configuration(Configuration.VERSION_2_3_32);;
